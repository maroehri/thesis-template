...
\begin{titlepage}
  ...
  % Variante 4
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=north west, yshift=-2cm, inner sep=0pt, outer sep=0pt] at (current page.north west) {
      \includegraphics[width=\paperwidth]{figures/background-12}
    };
  \end{tikzpicture}
  ...
  \vspace*{5cm} % Für die Varianten 1-3 des Hintergrunds reichen hier 3cm

  %%% Titel oben (Variante 1, 3 und 4)
